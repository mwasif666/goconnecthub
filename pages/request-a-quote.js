                                            ...
                                            <div className="row">
                                                <div className="col-md-6">
                                                    <div className="form-group">
                                                        <input className="form-control" type="text" name="name" data-label="Name" placeholder="Your name *" required />
                                                    </div>
                                                </div>
                                                <div className="col-md-6">
                                                    <div className="form-group">
                                                ...
                                                <div className="col-md-12">
                                                    <div className="form-group">
                                                        <textarea className="form-control" name="message" data-label="Message" placeholder="Message / Note" rows={5} defaultValue={""} />
                                                    </div>
                                                </div>
                                                <div className="col-md-12">
                                                    <button className="btn btn-brand-1-big" type="submit" disabled={isSubmitting}>
                                                        {isSubmitting ? "Sending..." : "Submit Now"}
                                                    </button>
                                                    {isToastVisible && (
                                                        <p className="quote-status" role="status" aria-live="polite">{toastMessage}</p>
                                                    )}
                                                </div>
                                            </div>
                                        </form>
                                ...
                                <div className="col-lg-7 mb-30">
                                    <div className="d-flex box-newsletter-right">
                                        <div className="box-map-2 wow animate__animated animate__fadeIn">
                                            <iframe title="Go Connect Hub location" src="https://www.google.com/maps?q=2+Peel+Lane,+Cheetham+Hill,+Manchester+M8+8RJ&output=embed" height={242} style={{ border: 0 }} allowFullScreen loading="lazy" referrerPolicy="no-referrer-when-downgrade" />
                                        </div>
