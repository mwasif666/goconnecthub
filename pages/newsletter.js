            ...
            <Layout headerStyle="newsletter" footerStyle="newsletter">
                            ...
                            <div className="col-sm-4">
                                <div className="card-offer card-offer-newsletter hover-up">
                                    <div className="card-image">
                                        <img src="/assets/imgs/page/homepage1/cargo-ship.png" alt="transp" />
                                    </div>
                                    <div className="card-info">
                                        ...
                                        <div className="box-button-offer">
                                            <a className="btn btn-link font-xxs color-brand-2">
                                                View Details
                                                <span>
                        ...
                        <div className="row align-items-center">
                                ...
                                <div className="box-images-pround-newsletter">
                                    <div className="box-images">
                                        ...
                                        <div className="image-2 shape-3">
                                            {" "}
                                            <img src="/assets/imgs/page/homepage1/icon1.png" alt="transp" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div className="col-sm-6 mb-30">
                                <div className="box-info-pround-newsletter">
                                    ...
                                    <div className="mt-30 text-start d-flex">
                                        {" "}
                    ...
                    <div className="container-sub">
                        <div className="row align-items-center">
                            <div className="col-sm-5">
                                {" "}
                                <span className="btn btn-tag font-xxs">Get in touch</span>
                                <h3 className="color-brand-2 font-16-bold mb-10 mt-10">
                                    Proud to Deliver <br className="d-none d-lg-block" />
                                ...
                                <div className="mt-20">
                                    {" "}
                                    <Link className="btn btn-brand-2 mr-20 font-xxs-medium" href="/contact">
                                        Contact Us
                                    </Link>
                                    <Link className="btn btn-link-medium font-xxs-medium" href="#">
                                        Learn More
                            ...
                            <div className="col-sm-7 position-relative">
                                ...
                                <div className="row">
                                    <div className="col-sm-6 pl-5 pr-5">
                                        <img className="mt-50" src="/assets/imgs/page/homepage3/img-info-5.png" alt="transp" />
                                    </div>
                                    <div className="col-sm-6 pl-5 pr-5">
                                        {" "}
                        ...
                        <div className="row">
                            <div className="col-sm-6">
                                <div className="item-reason">
                                    <div className="card-offer cardServiceStyle3 hover-up">
                                        <div className="card-image">
                                            <img src="/assets/imgs/page/homepage4/container.png" alt="transp" />
                                        </div>
                                        <div className="card-info">
                            ...
                            <div className="col-sm-6">
                                <div className="item-reason">
                                    <div className="card-offer cardServiceStyle3 hover-up">
                                        <div className="card-image">
                                            <img src="/assets/imgs/page/homepage4/24-hours.png" alt="transp" />
                                        </div>
                                        <div className="card-info">
                            ...
                            <div className="col-sm-6">
                                <div className="item-reason">
                                    <div className="card-offer cardServiceStyle3 hover-up">
                                        <div className="card-image">
                                            <img src="/assets/imgs/page/homepage4/stopwatch.png" alt="transp" />
                                        </div>
                                        <div className="card-info">
                            ...
                            <div className="col-sm-6">
                                <div className="item-reason">
                                    <div className="card-offer cardServiceStyle3 hover-up">
                                        <div className="card-image">
                                            <img src="/assets/imgs/page/homepage4/pallet.png" alt="transp" />
                                        </div>
                                        <div className="card-info">
                ...
                <section className="section mt-55 bg-1 position-relative newsletter-style block-info-3">
                    <div className="container-sub position-relative">
                        <div className="row">
                            <div className="col-sm-6 pt-25 pb-25">
                                {" "}
                                <span className="btn btn-tag">Get in touch</span>
                                <h6 className="color-brand-2 font-16-bold mb-15 mt-10">
                                    Proud to Deliver <br className="d-none d-lg-block" />
                                    Excellence Every Time
                                </h6>
                                ...
                                <div className="mt-0">
                                    {" "}
                                    <Link className="btn btn-brand-2 font-xxs mr-20" href="/contact">
                                        Contact Us
                                    </Link>
                                    <Link className="btn btn-link-medium font-xxs" href="#">
                                        Learn More
                                        <svg className="w-6 h-6 icon-16 ml-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M14 5l7 7m0 0l-7 7m7-7H3" />
                                        </svg>
