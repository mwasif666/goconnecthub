        ...
        <>
            <Layout>
                    ...
                    <div className="container">
                        <div className="content-detail">
                            <div className="box-pageheader-1 box-pageheader-services text-start pb-30">
                                <span className="btn btn-tag wow animate__animated animate__fadeIn">Our Services</span>
                                ...
                                <div className="row align-items-center">
                                    <div className="col-lg-6 mb-30">
                                        <div className="box-author">
                                            ...
                                            <div className="author-info wow animate__animated animate__fadeIn">
                                                <Link href="#">
                                                    <span className="font-xl-bold color-brand-2 author-name">Courtney Henry</span>
                                                </Link>
                                    ...
                                    <div className="col-lg-6 mb-30">
                                        <div className="d-flex justify-content-start justify-content-lg-end wow animate__animated animate__fadeIn">
                                            <span className="font-xs color-grey-700 mr-30">29 May 2026</span>
                                            <span className="font-xs color-grey-700 mr-30">125 Views</span>
                                            <span className="font-xs color-grey-700 mr-15">Share</span>
                    ...
                    <div className="container">
                        <div className="row">
                            ...
                            <div className="col-xl-10">
                                <img className="w-100 wow animate__animated animate__fadeIn" src="/assets/imgs/page/blog-single/img.png" alt="transp" />
                            </div>
                        </div>
                    </div>
                </div>
                <section className="section mt-50">
                    <div className="container">
                        <div className="content-detail">
                            <strong className="font-md-bold color-grey-900 mb-25 d-block wow animate__animated animate__fadeIn">Sea freight forwarding, also known as ocean freight forwarding, is a critical aspect of the global supply chain. It refers to the transportation of goods via cargo ships or vessels from one port to another. This mode of transportation is preferred by many businesses due to its cost-effectiveness, reliability, and ability to transport large quantities of goods. In this article, we will discuss the basics of sea freight forwarding, including its benefits, modes of transportation, and key players.</strong>
                            ...
                            <p className="wow animate__animated animate__fadeIn">
                                <img src="/assets/imgs/page/service-detail/img3.png" alt="transp" />
                            </p>
                            ...
                            <div className="row align-items-center">
                                ...
                                <div className="col-lg-5">
                                    <img className="wow animate__animated animate__fadeIn" src="/assets/imgs/page/service-detail/img4.png" alt="transp" />
                                </div>
                            </div>
                        </div>
                    </div>
